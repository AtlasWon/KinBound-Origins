// Plan view of Tideglass, for the city-layout pass. Same technique as
// mapwalk-atlas.js, but one map at a time and at full tile size, so a
// hundred and nineteen roofs can be judged as a drawing rather than as text.
const d = window.dev;
...
const MAPS = (window.__atlasMaps || ['tideglass']);
const out = [];
