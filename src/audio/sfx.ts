...
export const SFX: Record<string, SfxLayer[]> = {
  ...
  hit: [
    n(0.04, 5400, 0.17),
    n(0.12, 950, 0.20),
    t(0.20, 190, 0.17, { to: 95 }),
    p(0.08, 560, 0.09, { to: 300, duty: 0.25 }),
  ],
  hit_super: [
    n(0.035, 7400, 0.20),
    n(0.24, 1500, 0.24),
    t(0.32, 175, 0.21, { to: 52 }),
    p(0.17, 820, 0.15, { at: 0.02, to: 1900, duty: 0.125 }),
    p(0.28, 300, 0.10, { at: 0.06, to: 140, duty: 0.5 }),
  ],
  hit_weak: [
    n(0.05, 420, 0.11),
    n(0.09, 900, 0.07, { at: 0.02 }),
    t(0.16, 140, 0.11, { to: 90 }),
    p(0.12, 300, 0.07, { to: 170, duty: 0.5 }),
  ],
  ...
  fx_fire: [
    n(0.36, 3000, 0.14),
    p(0.32, 340, 0.12, { to: 180, duty: 0.125 }),
    t(0.30, 150, 0.12, { to: 90 }),
    n(0.16, 900, 0.11, { at: 0.26 }),
  ],
  fx_water: [
    n(0.32, 2200, 0.12),
    p(0.26, 700, 0.12, { to: 380, duty: 0.25 }),
    t(0.30, 210, 0.11, { to: 120 }),
    n(0.18, 4200, 0.10, { at: 0.26 }),
  ],
  fx_spark: [
    n(0.05, 7600, 0.17),
    p(0.24, 1800, 0.16, { to: 320, duty: 0.125, vibrato: 90 }),
    p(0.20, 2600, 0.10, { at: 0.03, to: 500, duty: 0.125 }),
    n(0.18, 2400, 0.11, { at: 0.1 }),
  ],
  fx_frost: [
  ...
  fx_quake: [
    t(0.55, 70, 0.22, { to: 38 }),
    n(0.55, 240, 0.15),
    t(0.30, 120, 0.13, { at: 0.18, to: 60 }),
    n(0.20, 700, 0.12, { at: 0.36 }),
  ],
  fx_psy: [
